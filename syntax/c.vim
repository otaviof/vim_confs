...
hi def link DocTags 	Special
hi def link DocParam 	Function
syn region DocTags  	contained start="{@link" end="}"
syn match  DocTags  	contained "@\(see\|param\|exception\|throws\)\s\+\S\+" contains=DocParam
" syn match  DocParam 	contained "\s\S\+"
syn match  DocTags  	contained "@\(version\|author\|return\|deprecated\|since\|brief\)\>"
syn match  vimFuncName 	"*\|\[\|\]\|{\|}\|,\|;\|=\|<\|>\|&&\|&\|||\|-\|++\|--\|::\|+\|-"
syn match  cDefine 	"!"
...
syn keyword	cType		int long short char void string pid_t pthread_t pthread_mutex_t
syn keyword	cType		signed unsigned float double
if !exists("c_no_ansi") || exists("c_ansi_typedefs")
  syn keyword   cType		size_t wchar_t ptrdiff_t sig_atomic_t fpos_t string pid_t pthread_t pthread_mutex_t
  syn keyword   cType		clock_t time_t va_list jmp_buf FILE DIR div_t ldiv_t ifstream ofstream stream fstream oftream ifstream istream ostream stream procbuf
